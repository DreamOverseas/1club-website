...
const ContactUs = () => {
  const mail_API_endpoint = `${
    import.meta.env.VITE_EMAIL_API_ENPOINT
  }360Club/enquiry`;
  ...
  return (
    <Container className="page-body-360Club">
      <Helmet>
        <title>Contact - 360Club</title>
        <meta
          name="description"
          content="Contact Us - 360Club, the private club for high-end customers."
        />
        <meta
          name="keywords"
      ...
      <Row>
        ...
        <Col>
          ...
          <Row>
            <p>
              <i className="bi bi-pin-angle"></i> &nbsp; Level 2, 171 La Trobe
              Street <br />
              Melbourne VIC 3000
              <br />
              Opening Mon-Fri 9:30-17:30
            </p>
          </Row>
          <Row>
            <p>
              <i className="bi bi-telephone-inbound"></i> &nbsp; +61 (0)413 168
              533
            </p>
          </Row>
          <Row>
            <p>
              <i className="bi bi-mailbox"></i> &nbsp; john.du@do360.com
            </p>
          </Row>
        </Col>
      </Row>
